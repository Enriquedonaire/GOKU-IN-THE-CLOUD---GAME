...
let audioMainPage = new Audio('Dragon Ball 8 Bits Mystical Adventure Opening.mp3');
let audiogameOverPage = new Audio ('Dragon ball Super  Ultra Instinct 8bit Cover.mp3');
let startAudio = new Audio('Dragon Ball Z Opening 8 bit.mp3');
let audioWiningPage = new Audio('Dragon ball z cancion.mp3');
let audioGokuWin = new Audio('goku-kamehameha-tonos.mp3');
let goku = new Image;
goku.src = 'goku-Ready.png';
let fg = new Image;
fg.src = 'mountainSouth.png';
let mountainNorth = new Image;
mountainNorth.src = 'mountainNorth.png';
...
sphere1.src = 'Sphere1.png'
let sphere2 = new Image
sphere2.src ='Sphere2.png'
let sphere3 = new Image
sphere3.src = 'Sphere3.png'
let sphere4 = new Image
sphere4.src = 'Sphere4.png'
let sphere5 = new Image
sphere5.src = 'Sphere5.png'
let sphere6 = new Image
sphere6.src = 'Sphere6.png'
let sphere7 = new Image
sphere7.src = 'Sphere7.png'
